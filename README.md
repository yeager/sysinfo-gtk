# sysinfo gtk [![Version](https://img.shields.io/badge/version-0.1.2-blue.svg)](https://github.com/yeager/sysinfo-gtk)



## Description

sysinfo gtk is a GTK4/Adwaita application 
...
```bash
git clone https://github.com/yeager/sysinfo-gtk.git
cd sysinfo-gtk
pip install -e .
```
...
This application is managed on Transifex: https://app.transifex.com/danielnylander/sysinfo-gtk/
